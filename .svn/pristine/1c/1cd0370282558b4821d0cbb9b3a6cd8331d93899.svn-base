      ...
      <div class="article">
        ...
        <div class="cnt"> 
          ...
          <div class="t_w">
			...
			<form action="addMember.nao" method="post">
            ...
            <table class="tb tb_row tb_ip">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" id="id" name="id" value=""> <a href="javascript:idCheck()" class="btn btn_check"><span>중복확인</span></a></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                  		<select  name="division">
                  			<option value="01">매체사</option>
                  			<option value="02">광고주</option>
                  		</select>
                  </td>
                </tr>
<!--                 

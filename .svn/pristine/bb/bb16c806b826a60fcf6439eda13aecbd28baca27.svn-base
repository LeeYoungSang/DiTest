...
public class UpdateMachineCommand implements Command {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(member == null) {
			...
			System.out.println("매장유형" + location_type);
			...
			boolean result = dao.updateMachine(machine_num, machine_type, installed_place, detail_place, location_x, location_y, location_type,
											   injectionTime_BT,unusedTime,injectionTime_UUT,usedTimes,injectionTime_UT);

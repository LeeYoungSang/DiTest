...
public class UpdateNoticeFormCommand implements Command {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(member == null) {
			...
			Map<String, Object> notice = dao.getNotice(notice_num);
			
			request.setAttribute("notice", notice);
			
			action.setRedirect(false);
			action.setPath("WEB-INF/notice/updateNoticeForm.jsp");
		}

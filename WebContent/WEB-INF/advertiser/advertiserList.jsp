...
<!--               
 ...
 -->
                <td><%= advertiser.get("advertiser_num") %></td>
                <td><a href="updateAdvertiserForm.nao?advertiser_num=<%= advertiser.get("advertiser_num") %>"><%= advertiser.get("advertiser_name") %></a></td>
              </tr>
 <%
		}

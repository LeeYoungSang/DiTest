...
public class CommandFactory {
	...
	private CommandFactory() {
		...
		map.put("/DiClean/machinePopList.nao", 					"kr.co.nao.command.machine.MachinePopListCommand");
		map.put("/DiClean/updatePopMachine.nao", 				"kr.co.nao.command.machine.UpdatePopMachineCommand");
		...
		map.put("/DiClean/optionList.nao", 						"kr.co.nao.command.client.ClientMachineOptionCommand");
		...
		map.put("/DiClean/statisticsAjax2.nao", 					"kr.co.nao.command.statistics.StatisticsAjaxCommand2"); //통계 ajax

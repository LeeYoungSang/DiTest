...
public class StatisticsAjaxCommand2 implements Command 
{
...
//			request.setAttribute("list", stList);
			...
			String testVal = json.toJSONString();
			
			System.out.println("testVal:"+testVal);
			
			request.setAttribute("list", testVal);
			
			action.setRedirect(false);
			action.setPath("WEB-INF/statistics/ajaxValue.jsp");
		}
